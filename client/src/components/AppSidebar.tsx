      ...
      <SidebarFooter className="p-4">
        <div className="flex items-center gap-3 p-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-foreground truncate" data-testid="text-username">Admin</p>
            <p className="text-xs text-muted-foreground truncate" data-testid="text-user-role">Administrador</p>
          </div>
          <Button 
            size="icon" 
            variant="ghost"
